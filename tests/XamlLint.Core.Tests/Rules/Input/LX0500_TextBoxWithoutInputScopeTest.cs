...
public sealed class LX0500_TextBoxWithoutInputScopeTest
{
    [Fact]
    public void TextBox_without_InputScope_on_WinUI3_is_flagged()
    {
        XamlDiagnosticVerifier<LX0500_TextBoxWithoutInputScope>.Analyze(
            """
    ...
    {
        // MAUI uses Entry.Keyboard (LX0503) rather than TextBox.InputScope.
        XamlDiagnosticVerifier<LX0500_TextBoxWithoutInputScope>.Analyze(
            """
            <Grid xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation">
                <TextBox />
