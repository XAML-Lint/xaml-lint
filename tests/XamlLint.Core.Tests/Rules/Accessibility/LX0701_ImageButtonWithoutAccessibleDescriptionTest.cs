...
public sealed class LX0701_ImageButtonWithoutAccessibleDescriptionTest
{
    ...
    {
        XamlDiagnosticVerifier<LX0701_ImageButtonWithoutAccessibleDescription>.Analyze(
            $"""
    ...
    public void ImageButton_with_AutomationId_is_not_flagged()
    {
        ...
        // author wired the button into automation, same rationale as LX0700.
        XamlDiagnosticVerifier<LX0701_ImageButtonWithoutAccessibleDescription>.Analyze(
            $"""
            <ContentPage xmlns="{MauiXmlns}">
