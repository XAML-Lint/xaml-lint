...
public sealed class LX0100_GridRowWithoutDefinitionTest
{
    [Fact]
    public void Grid_Row_out_of_range_is_flagged()
    {
        ...
        XamlDiagnosticVerifier<LX0100_GridRowWithoutDefinition>.Analyze(
            """
    ...
    public void Element_syntax_Grid_Row_is_flagged()
    {
        ...
        XamlDiagnosticVerifier<LX0100_GridRowWithoutDefinition>.Analyze(
            """
            {|LX0100|}<Grid xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation">
                <Button>
                    <Grid.Row>1</Grid.Row>
                </Button>
            </Grid>
