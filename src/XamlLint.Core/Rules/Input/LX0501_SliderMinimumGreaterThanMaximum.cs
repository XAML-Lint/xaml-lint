...
[XamlRule(
    ...
    Dialects = Dialect.Wpf | Dialect.Maui | Dialect.Avalonia,
    HelpUri = "https://github.com/XAML-Lint/xaml-lint/blob/main/docs/rules/LX0501.md")]
public sealed partial class LX0501_SliderMinimumGreaterThanMaximum : IXamlRule
{
