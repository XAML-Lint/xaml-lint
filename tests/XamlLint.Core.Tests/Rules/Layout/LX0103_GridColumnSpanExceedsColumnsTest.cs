...
public sealed class LX0103_GridColumnSpanExceedsColumnsTest
{
    [Fact]
    public void ColumnSpan_greater_than_column_count_is_flagged()
    {
        XamlDiagnosticVerifier<LX0103_GridColumnSpanExceedsColumns>.Analyze(
            """
    ...
    {
        // Element syntax is uncommon but legal. The bare {|LX0103|} marker asserts that a
        // diagnostic fires for this rule somewhere in the document.
        XamlDiagnosticVerifier<LX0103_GridColumnSpanExceedsColumns>.Analyze(
            """
            {|LX0103|}<Grid xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation">
                <Button>
