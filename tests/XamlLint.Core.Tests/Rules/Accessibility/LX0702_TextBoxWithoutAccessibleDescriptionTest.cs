...
public sealed class LX0702_TextBoxWithoutAccessibleDescriptionTest
{
    ...
    {
        XamlDiagnosticVerifier<LX0702_TextBoxWithoutAccessibleDescription>.Analyze(
            $"""
